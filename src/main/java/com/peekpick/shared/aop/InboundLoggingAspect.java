...
@Aspect
@Component
public class InboundLoggingAspect {
    ...
    private void logRequest(
        ...
        if (request != null) {
            logger.info(
                    "[PEEKPICK Incoming Request] HTTP Method: {}, URL: {}, Body: {}",
                    request.getMethod(),
    ...
    private void logResponse(
        ...
        if (response != null) {
            logger.info("[PEEKPICK Outgoing Response] Status: {},Result: {}", response.getStatus(), toPrettyJson(result));
        }
    }
